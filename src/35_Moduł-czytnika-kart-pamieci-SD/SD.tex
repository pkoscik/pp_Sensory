...
\begin{figure}[h!]
\centering
\includegraphics[width=0.81\linewidth]{fig/SD/zasada_dzialania/schemat2.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\linewidth]{fig/SD/polaczenie_modulu/uklad2.jpg}
